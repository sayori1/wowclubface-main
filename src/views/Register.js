  ...
  const register = () => {
    ...
    updateProfile(userDetails.token, {
      ...
      .then((res) => {
        ...
        if (res.code === 200) {
          return reduxSaveUser({ ...res.body, token: userDetails.token });
        }

        if (res.code === 409) {
          setError('Пользовать с данным e-mail уже существует');
        } else {
        ...
        <View style={styles.buttonWrapper}>
          <Button
            ...
            disabled={
              ...
              !!nameError.length || !!emailError.length || !!passwordError.length
            }
          />
        </View>
      </View>
